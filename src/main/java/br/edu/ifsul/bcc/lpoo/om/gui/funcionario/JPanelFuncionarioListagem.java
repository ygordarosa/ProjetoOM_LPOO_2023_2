...
public class JPanelFuncionarioListagem extends JPanel implements ActionListener{
    ...
    public JPanelFuncionarioListagem(JPanelFuncionario pnlAFuncionario, Controle controle){
        
        this.pnlFuncionario = pnlAFuncionario;
    ...
    public void populaTable(){
        ...
        try {
            ...
            List<Funcionario> listFuncionarios = (List<Funcionario>) controle.getConexaoJDBC().listFuncionario();
    ...
    private void initComponents(){
        ...
        modeloTabela = new DefaultTableModel(
            new String [] {
                    "CPF", "Nome", "Cargo", "Data de Admissao"
            }, 0);
